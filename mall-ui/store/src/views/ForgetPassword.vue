<template>
  <div class="forget-password">
    ...
    <!-- 顶部logo -->
    <div class="logo-box">
      <img src="./../assets/logo.png" width="150" @click="$router.push('/')" />
      <div>修改密码</div>
    </div>
      ...
      >
        ...
        <!-- <FormItem>
          <Button
            ...
            >{{ verifyStatus ? "验证通过" : "点击完成安全验证" }}</Button
          >
        </FormItem> -->
        <FormItem>
          <Button type="error" @click="next" :loading="loading" long
            >下一步</Button
          >
        </FormItem>
      </Form>
...
export default {
  ...
  mounted() {
    document.querySelector(".forget-password").style.height =
