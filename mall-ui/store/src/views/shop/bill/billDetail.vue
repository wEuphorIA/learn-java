  ...
  <div class="bill-detail">
    <Card>
      ...
      <div class="flex flex_align_item">
          ...
          <div class="procedure_item" v-for="(item, index) in billStatusStep">
            <div class="icon" :class="item.className">
              <Icon
                type="md-checkmark"
                size="14"
                v-if="item.className === '' || bill.billStatus === 'COMPLETE'"
              />
        ...
        <div>
          <Button type="info" @click="download()" style="margin-left: 10px"
            >下载账单</Button
          >
          <Button
          ...
          children: [
            {
              ...
              render: (h, params) => {
                return h("priceColorScheme", {
                  props: {
                    value: 0 - params.row.refundPrice,
                    color: this.$mainColor,
                  },
                });
              },
            ...
            },
            {
              ...
              render: (h, params) => {
                return h(
                  "div",
                  this.$options.filters.unitPrice(
                    params.row.distributionRefundCommission,
                    "￥"
                  )
                );
              },
            },
            {
              ...
              render: (h, params) => {
                return h(
                  "div",
                  this.$options.filters.unitPrice(
                    params.row.refundCommissionPrice,
                    "￥"
                  )
                );
              },
            ...
            },
            {
              ...
              render: (h, params) => {
                if (params.row.flowType == "PAY") {
                  ...
                  return h("priceColorScheme", {
                    props: { value: 0 - params.row.finalPrice },
                  });
                }
              },
            },
          ...
          children: [
            {
              ...
              render: (h, params) => {
                if (params.row.commissionPrice == 0) {
                  ...
                  return h("priceColorScheme", {
                    props: { value: 0 - params.row.commissionPrice },
                  });
                }
              },
            },
            {
              ...
              render: (h, params) => {
                if (params.row.distributionRebate == 0) {
                  ...
                  return h("priceColorScheme", {
                    props: { value: 0 - params.row.distributionRebate },
                  });
                }
              },
            },
  ...
  methods: {
    ...
    getBillStatusStep() {
      ...
      if (this.bill.billStatus === "COMPLETE") {
        this.billStatusStep[this.billStatusStep.length - 1].className =
          "current";
      }
    },
    //核对结算单
    ...
    initTable() {
      ...
      this.billData[0].distributionCommission =
        this.bill.distributionCommission;
      this.billData[0].commissionPrice = this.bill.commissionPrice;
      this.billData[0].refundPrice = this.bill.refundPrice;
      this.billData[0].siteCouponRefundCommission =
        this.bill.siteCouponRefundCommission;
      this.billData[0].pointRefundSettlementPrice =
        this.bill.pointRefundSettlementPrice;
      this.billData[0].kanjiaRefundSettlementPrice =
        this.bill.kanjiaRefundSettlementPrice;
      this.billData[0].distributionRefundCommission =
        this.bill.distributionRefundCommission;
