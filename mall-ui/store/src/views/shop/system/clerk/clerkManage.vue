  ...
  <div class="search">
    <Card>
      ...
      <div class="boxBg boxPad m24">
        <div class="export">
          <Button @click="add" type="primary"  class="mr_20">添加</Button>
          <Button @click="delAll" class="mr_20">批量删除</Button>
    ...
    >
      ...
      >
        ...
        <Form-item label="所属部门：">
          <department-tree-choose
            @on-change="handleEditSelectDepTree"
            ref="depTree"
          ></department-tree-choose>
        </Form-item>
      </Form>
      <div slot="footer">
        ...
        <Button type="primary" :loading="submitLoading" @click="updateSubmit"
          >提交</Button
        >
      </div>
    </Modal>
    ...
    >
      <Form ref="form" :model="form" :label-width="90" :rules="formValidate">
        <FormItem label="手机号：" prop="mobile">
          <Input
            placeholder="请输入要添加的会员手机号码"
            maxlength="11"
            style="width: 75%"
            v-model="form.mobile"
            autocomplete="off"
            @on-change="checkClerks"
          />
        ...
        <FormItem
          label="角色"
          prop="roles"
          v-if="(oldMember || newMember) && form.isSuper == 0"
        >
      ...
      <div slot="footer">
        ...
        <Button type="primary" :loading="submitLoading" @click="submitUser"
          >提交</Button
        >
      </div>
    </Modal>
