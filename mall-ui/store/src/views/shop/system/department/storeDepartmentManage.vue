...
<template>
  <div class="search">
    <Card>
      ...
      <div class="export">
        <i-switch v-model="strict" size="large" class="mr_20">
          <span slot="open">级联</span>
          <span slot="close">单选</span>
        </i-switch>
        <Button @click="addRoot" type="primary" class="mr_20">添加部门</Button>
        <Button @click="add" type="primary" class="mr_20">添加子部门</Button>
