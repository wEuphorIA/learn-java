            ...
            >
              ...
              <FormItem label="店铺地址：" prop="storeAddressPath">
                ...
                <Button
                  ...
                  @click="handleChangeAddress('storeAddress')"
                  >选择</Button
                >
              </FormItem>
              ...
              <FormItem label="店铺楼层：" prop="content" class="wangEditor">
                <i-switch
                  v-model="form.pageShow"
                  @on-change="pageShow"
                ></i-switch>
                <span class="desc"
                  >店铺楼层装修是否开启，开启后移动端PC端将会自动展示装修的内容</span
                >
              </FormItem>
              <FormItem label="开启自提：" prop="content" class="wangEditor">
                <i-switch
                  v-model="form.selfPickFlag"
                  @on-change="changeSelfPickFlag"
                ></i-switch>
          ...
          <TabPane label="发货地址">
            ...
            >
              ...
              <FormItem label="地址：" prop="salesConsignorAddressId">
                ...
                <Button
                  style="margin-left: 10px"
                  @click="handleChangeAddress('addressGoods')"
                  >选择</Button
                >
              </FormItem>
          ...
          <TabPane label="退货地址" name="REFUND_GOODS_ADDRESS">
            ...
            >
              ...
              <FormItem label="售后地址：">
                ...
                <Button
                  style="margin-left: 10px"
                  @click="handleChangeAddress('salesConsigneeAddressPath')"
                  >选择</Button
                >
              </FormItem>
