<template>
  <div class="search ship">
      ...
      <div class="boxBg boxPad">
        ...
        >
          <TabPane label="运费模板" name="INFO">
            <table
              class="ncsc-default-table order m-b-30"
              :key="index"
              v-for="(item, index) in shipInfo"
            >
              <tbody>
                <tr>
                ...
                <tr>
                  <th colspan="20">
                    ...
                    <span class="fr m-r-5">
                      ...
                      <Button @click="remove(item.id)" class="ivu-del"
                        >删除</Button
                      >
                    </span>
                  </th>
                ...
                <template v-if="item.pricingMethod !== 'FREE'">
                  <tr
                    v-for="(children, index) in item.freightTemplateChildList"
                    :key="index"
                  >
                    <td class="bdl"></td>
                    <td
                      class="cell-area tl w150"
                    ...
                    <td class="bdr">
                      <span class="yuan">￥</span
                      ><span class="integer">{{
                        children.continuedPrice | unitPrice
                      }}</span>
                    </td>
                  </tr>
                </template>
                      ...
                      <table cellspacing="0" class="ncsc-default-table">
                        ...
                        <tbody>
                          <tr
                            ...
                            v-for="(
                              item, index
                            ) in form.freightTemplateChildList"
                            :key="index"
                          >
                            <td></td>
    ...
    <multiple-region ref="region" @selected="handleSelect"> </multiple-region>
  </div>
</template>
        ...
        if (valid) {
          if (this.form.pricingMethod != "FREE") {
            ...
            for (
              ...
              console.log(this.form.freightTemplateChildList[i])
              // if (
