          ...
          },
          {
            ...
            render: (h, params) => {
              if (params.row.complainStatus == "NEW") {
                return h('div', [h("span", { class: "statusDot statusRed" }, '新投诉'),]);
              } else if (params.row.complainStatus == "CANCEL") {
                return h('div', [h("span", { class: "statusDot statusGray" }, '已撤销'),]);
              } else if (params.row.complainStatus == "WAIT_APPEAL") {
                return h('div', [h("span", { class: "statusDot statusBlur" }, '待申诉'),]);
              } else if (params.row.complainStatus == "COMMUNICATION") {
                return h('div', [h("span", { class: "statusDot statusBlur" }, '对话中'),]);
              }else if (params.row.complainStatus == "WAIT_ARBITRATION") {
                return h('div', [h("span", { class: "statusDot statusBlur" }, '等待仲裁'),]);
              }else if (params.row.complainStatus == "COMPLETE") {
                return h('div', [h("span", { class: "statusDot statusGray" }, '已完成'),]);
              }
            }
          },
