    ...
    <Card>
      <div class="boxBg">
        <div class="main-content">
          <div class="div-form-default">
            ...
            <dl>
              ...
              <dd>
                ...
                <a>{{ complaintInfo.goodsName }}</a
                ><br />
                <span
                  >￥{{ complaintInfo.goodsPrice | unitPrice }} *
                  {{ complaintInfo.num }}(数量)</span
                >
              </dd>
            </dl>
            <dl>
          ...
          <div v-if="complaintInfo.complainStatus !== 'WAIT_APPEAL'">
            <h3 class="tit">商家申诉信息</h3>
            <div class="div-form-default">
              <dl>
                <dt>申诉时间</dt>
              ...
              <dl>
                <dt>申诉凭证</dt>
                <dd v-if="appealImages == ''">暂无申诉凭证</dd>
                <dd v-else>
                  <div
                    class="div-img"
          ...
          <div v-if="complaintInfo.complainStatus === 'WAIT_APPEAL'">
            ...
            <div class="div-form-default">
              ...
              <dl>
                ...
                <dd>
                  <div
                    class="complain-upload-list"
                    :key="index"
                    v-for="(item, index) in appeal.appealImages"
                  >
          ...
          <div v-if="complaintInfo.complainStatus === 'COMPLETE'">
            <h3 class="tit">仲裁结果</h3>
            <div class="div-form-default">
              <dl>
                <dt>仲裁意见</dt>
                <dd>
          ...
          <div class="div-form-default">
            ...
            <dl>
              ...
              <dd>
                <priceColorScheme
                  :value="complaintInfo.orderPrice"
                  :color="$mainColor"
                ></priceColorScheme>
              </dd>
            </dl>
...
export default {
  ...
  methods: {
    ...
    appealSubmit() {
      ...
      this.appeal.appealImages = this.appeal.appealImages.map(
        (item) => item.url
      );
