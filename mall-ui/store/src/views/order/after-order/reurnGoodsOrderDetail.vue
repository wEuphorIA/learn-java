  ...
  <div class="search base-detail">
    <Card>
        ...
        <div class="main-content">
          <div class="">
            ...
            <div
              ...
              v-if="
                afterSaleInfo.serviceStatus == 'BUYER_RETURN' ||
                (afterSaleInfo.serviceStatus == 'COMPLETE' &&
                  afterSaleInfo.serviceType != 'RETURN_MONEY')
              "
            >
              <h3 class="tit">回寄物流信息</h3>
              <dl>
                <dt>物流公司：</dt>
                <dd>
              ...
              <dl>
                ...
                <dd>
                  <Button
                    ...
                    v-if="afterSaleInfo.afterSaleAllowOperationVO.rog"
                  >
                    确认收货
                  </Button>
                  <Button
            ...
            <div
              v-if="
                afterSaleInfo.afterSaleAllowOperationVO.return_goods &&
                afterSaleInfo.serviceType == 'EXCHANGE_GOODS'
              "
            >
              <h3 class="tit">换货</h3>
            ...
            <div
              v-if="
                afterSaleInfo.serviceType == 'EXCHANGE_GOODS' &&
                afterSaleInfo.serviceStatus == 'SELLER_RE_DELIVERY'
              "
            >
            ...
            <div class="div-form-default">
              <dl>
                ...
                <dd>
                  ...
                  <div class="rText">
                    <div>{{ afterSaleInfo.goodsName }}</div>
                  <div>{{ afterSaleInfo.num }}(数量)</div>
                  </div>
              ...
              <dl v-if="afterSaleInfo.actualRefundPrice">
                <dt>实际退款金额：</dt>
                <dd>
                  {{ afterSaleInfo.actualRefundPrice | unitPrice("￥") }}
                </dd>
              </dl>
      ...
      <div class="boxBg mt_20">
        <div class="main-content adviceRow">
          <div v-if="afterSaleInfo.serviceStatus == 'APPLY'">
            <h3 class="tit">商家处理意见</h3>
            <div class="div-form-default">
              <dl>
                <dt>商家：</dt>
                <dd>
    ...
    <Modal v-model="modalVisible" width="500px">
      ...
      <div slot="footer" style="text-align: right">
        ...
        <Button type="success" size="large" @click="orderDeliverySubmit"
          >发货</Button
        >
      </div>
    </Modal>
