<template>
  <div class="search base-detail new-pintuan">
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="130" :rules="formValidate">
        ...
        <FormItem label="参团人数：" prop="requiredNum" :label-width="130">
          ...
          <span class="tip">参团人数不少于2人，不得超过10人。</span>
        </FormItem>
        <FormItem label="限购数量：" prop="limitNum" :label-width="130">
          ...
          <span class="tip">如果设置为0则视为不限制购买数量</span>
        </FormItem>
        <FormItem label="虚拟成团：" prop="fictitious">
          <RadioGroup button-style="solid" v-model="form.fictitious">
          ...
          <br />
          <span class="tip">开启虚拟成团后，24小时人数未满的团，系统将会模拟匿名买家凑满人数，使该团成团；您只需要对已付款参团的真实买家发货；建议合理开启以提高成团率</span>
        </FormItem>
        <FormItem label="拼团规则：" prop="pintuanRule">
          <Input v-model="form.pintuanRule" type="textarea" :resize="false" :rows="4" clearable maxlength="255"/>
          <br />
          <span class="tip">拼团规则描述不能为空且不能大于255个字，会在WAP拼团详情页面显示</span>
        </FormItem>
      </Form>
      <div class="btnBox">
