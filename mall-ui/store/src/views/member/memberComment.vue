        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.status === "OPEN") {
              return h("span", { class: "statusDot statusRreen" }, "展示");
            } else {
              return h("span", { class: "statusDot statusGray" }, "隐藏");
            }
          },
        },
        {
          ...
          render: (h, params) => {
            if (params.row.replyStatus) {
              return h("span", { class: "statusDot statusRreen" }, "已回复");
            } else {
              return h("span", { class: "statusDot statusBlur" }, "未回复");
            }
          },
        },
