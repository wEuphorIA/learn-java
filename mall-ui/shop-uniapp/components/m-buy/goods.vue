    ...
    >
      ...
      <view class="goods-box bottom">
        ...
        <scroll-view class="goods-skus-box" :scroll-y="true">
          ...
          <!-- 数量 -->
          <view class="goods-skus-number flex flex-a-c flex-j-sb" v-if="routerVal.type===undefined||routerVal.type===null">
        ...
        <view class="btns">
          <view
            class="box-btn card"
            v-if="
              buyType != 'PINTUAN' &&routerVal.type!=='ms'
            "
...
.buy {
  ...
  box-shadow: 0 2px 6px 0 rgba($main-color, 0.2);
}
