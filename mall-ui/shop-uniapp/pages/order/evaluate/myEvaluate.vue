<template>
  <view>
    <u-navbar :is-back="true" title="我的评价"> </u-navbar>
    <view class="wrap" :style="{ paddingTop: capsuleBottom + 'px' }">
      ...
      >
        <swiper-item v-for="(item, listIndex) in list" :key="listIndex">
          <scroll-view
            scroll-y
            style="height: 100%"
            @scrolltolower="renderData(listIndex)"
          >
            <div
              text="尚无需要评价的商品"
              mode="list"
                  ...
                  <view class="description">
                    ...
                    <view class="goods-imgs-view" v-if="order.image">
                      <view
                        class="img-view"
                        v-if="order.image"
                        v-for="(img, imgIndex) in order.image.split(',')"
                        :key="imgIndex"
                      >
                        <u-image
                          v-if="order.image"
            ...
            <uni-load-more :status="params.loadStatus" v-if="orderList.length>0"></uni-load-more>
          </scroll-view>
        </swiper-item>
      </swiper>
    </view>
