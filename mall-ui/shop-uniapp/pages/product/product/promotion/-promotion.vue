<template>
  <view>
    ...
    >
      <view
        v-if="res != null"
        v-for="(item, index) in Object.keys(res)"
        :key="index"
      >
        <div
          class="promotion_col"
        ...
        >
          ...
          <div class="flex">
            ...
            <div class="text proText">
              满{{ res[item].fullMoney }}元，立享优惠
            </div>
          </div>
        </div>
        <div
      ...
      <view class="promotion_row">
        <view>
          <div
            class="promotion_col coupon"
            v-if="couponList && promotionIndex == 1"
          >
            <!-- 优惠券 -->
