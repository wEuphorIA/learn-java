      ...
      <div class="block-4" v-if="cashierParams.price > 0">
        ...
        <u-row class="row">
          <div class="col1" size="100" style="text-align: left">
            <div
              class="payItem"
              v-if="payList.includes('ALIPAY')"
              @click="awaitPay('ALIPAY')"
            >
              <u-icon
                class="method_icon"
            ...
            <div
              class="payItem"
              v-if="payList.includes('WECHAT')"
              @click="awaitPay('WECHAT')"
            >
              <u-icon
                class="method_icon"
            ...
            <!-- <div
              class="payItem"
              v-if="payList.includes('WALLET')"
              @click="awaitPay('WALLET')"
            >
              <u-icon
                class="method_icon"
  ...
  methods: {
    ...
    async pay(payment) {
      ...
      const searchParams = {
        ...
        price: this.cashierParams.price,
      };
      if (paymentMethod === 'WECHAT') {
        uni.navigateTo({
          url: `/pages/cart/payment/pay?item=${encodeURIComponent(
