<template>
  <view>
    <u-navbar :is-back="true" title="关于我们"></u-navbar>

    <view class="edition-intro" :style="{ paddingTop: capsuleBottom + 'px' }">
      ...
      <u-cell-group class="cell" :border="false">
        ...
        <u-cell-item
          title="功能介绍"
          @click="navigateTo('/pages/mine/set/versionFunctionList')"
        ></u-cell-item>
        ...
        <u-cell-item
          title="证照信息"
          @click="navigateTo('/pages/mine/help/photo')"
        ></u-cell-item>
        <u-cell-item
          title="服务协议"
          @click="navigateTo('/pages/mine/help/serve')"
        ></u-cell-item>
        <u-cell-item
          title="隐私协议"
          @click="navigateTo('/pages/mine/help/privacy')"
        ></u-cell-item>
        <u-cell-item
          title="关于我们"
          :border-bottom="false"
          @click="navigateTo('/pages/mine/help/about')"
        ></u-cell-item>
      </u-cell-group>

      <view class="intro">
        <view>{{
          config.customerServiceMobile
            ? `客服热线：${config.customerServiceMobile}`
            : ``
        }}</view>
        <view style="margin: 20rpx 0 0 0">{{
          config.customerServiceEmail
            ? `客服邮箱：${config.customerServiceEmail}`
            : ``
        }}</view>
