  ...
  <view class="person-msg">
    ...
    <view :style="{ paddingTop: capsuleBottom + 'px' }">
      ...
      <u-form :model="form" ref="uForm" class="form">
        <u-form-item label="头像" label-width="150" right-icon="arrow-right">
          <view class="headIcon">
            <image
              @click="changeFace"
        ...
        <u-form-item label="手机号" label-width="150" right-icon="arrow-right">
          <view v-if="form.mobile">
            {{ form.mobile }}
          </view>
          <view v-else>
            <div @click="navigateTo(form.username)">
              绑定手机号码
            </div>
          </view>
        </u-form-item>
...
export default {
  ...
  methods: {
    ...
    navigateTo(username) {
      uni.navigateTo({
        url:
          '/pages/mine/set/securityCenter/bindMobile' + '?username=' + username,
      });
    },
  },
