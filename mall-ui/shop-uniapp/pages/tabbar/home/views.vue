  ...
  <div class="wrapper homeBox">
    ...
    <div v-for="(item, index) in pageData.list" :key="index">
      ...
      /> -->
        ...
        <flexOne v-if="item.type == 'menu'" :res="item.options" />
        <goods
...
export default {
  ...
  mounted() {
    ...
    uni.getSystemInfo({
      success: () => {
        this.capsuleBottom = uni.getMenuButtonBoundingClientRect().bottom + 40;
      },
    });
  },
  methods: {
...
.headBox {
  ...
  top: 0;
  padding-top: 100rpx;
  background-image: linear-gradient(rgba(#fe6b3d, 1), rgba(#f3c2a8, 1));
  .title {
    font-size: 32rpx;
    line-height: 60rpx;
    color: #fff;
