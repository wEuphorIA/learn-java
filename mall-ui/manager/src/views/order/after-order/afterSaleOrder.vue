<template>
  <div class="contentBox">
    ...
    <div class="boxBg boxPad m24">
      <div class="tableBox">
        <Tabs value="" @on-click="serviceStatusClick">
          <TabPane
...

        {
          ...
          render: (h, params) => {
            if (params.row.serviceStatus == "APPLY") {
              ...
              return h("div", [
                h("span",{ class: "statusDot statusGray" }, "卖家确认收货"),
              ]);
            } else if (params.row.serviceStatus == "SELLER_TERMINATION") {
              return h("div", [
                h("span", { class: "statusDot statusGray" }, "卖家终止售后"),
              ]);
              ...
              return h("div", [
                h("span", { class: "statusDot statusOrange" }, "待平台退款"),
              ]);
            }
          },
        },
