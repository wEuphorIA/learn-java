<template>
  <div class="base-detail orderDetail">
    <div class="boxBg">
      <div class="headBtn">
        <div class="right">
          <Button
            ...
            >打印发货单</Button
          >
          <Button @click="orderLog" type="primary" class="ml_20"
            >订单日志</Button
          >
          <Button
        ...
        <Row>
            ...
            <div class="div-item">
              ...
              <div class="div-item-right">
                ...
                <span
                  ...
                  v-if="
                    orderInfo.orderStatusValue === '已付款' ||
                    orderInfo.orderStatusValue === '已发货'
                  "
                  >{{ orderInfo.orderStatusValue }}</span
                >
                <span
                  ...
                  v-if="
                    ...
                    orderInfo.orderStatusValue === '待核验'
                  "
                  >{{ orderInfo.orderStatusValue }}</span
                >
                <span
                ...
                <span
                  ...
                  v-if="
                    orderInfo.orderStatusValue === '已完成' ||
                    orderInfo.orderStatusValue === '已关闭'
                  "
                  >{{ orderInfo.orderStatusValue }}</span
                >
              </div>
          ...
          <Col span="12">
            ...
            <div class="div-item" v-if="orderInfo.order.needReceipt == true">
              ...
              <div class="div-item-right">
                {{
                  orderInfo.receipt && orderInfo.receipt.receiptTitle
            ...
            <div
              class="div-item"
              v-if="
                orderInfo.order.needReceipt == true &&
                orderInfo.receipt &&
            ...
            >
              ...
              <div class="div-item-right">
                {{
                  orderInfo.receipt && orderInfo.receipt.taxpayerId
                    ? orderInfo.receipt.taxpayerId
                    : "暂无"
                }}
              </div>
            ...
            <div class="div-item" v-if="orderInfo.order.needReceipt == true">
              ...
              <div class="div-item-right">
                <priceColorScheme
                  v-if="orderInfo.receipt && orderInfo.receipt.receiptPrice"
                  :value="orderInfo.receipt.receiptPrice"
                  :color="$mainColor"
                ></priceColorScheme>
                <span v-else>暂无</span>
              </div>
            ...
            <div class="div-item" v-if="orderInfo.order.needReceipt == true">
              ...
              <div class="div-item-right">
                {{
                  orderInfo.receipt
                    ? orderInfo.receipt.receiptStatus == 0
                      ? "未开"
                      : "已开"
                    : "空"
                }}
        ...
        <div class="goods-total">
          <ul>
            ...
            >
              ...
              <span class="txt">
                <priceColorScheme
                  :value="orderInfo.order.priceDetailDTO.couponPrice"
                  :color="$mainColor"
                ></priceColorScheme>
              </span>
            </li>
            ...
            <li>
              ...
              <span class="txt flowPrice"
                >¥{{
                  orderInfo.order.priceDetailDTO.flowPrice | unitPrice
                }}</span
              >
            </li>
          </ul>
      ...
      <div>
        ...
        >
          <FormItem label="收件人：" prop="consigneeName">
            <Input v-model="addressForm.consigneeName" maxlength="20"></Input>
          </FormItem>
          <FormItem label="联系方式：" prop="consigneeMobile">
            <Input v-model="addressForm.consigneeMobile" maxlength="11"></Input>
          </FormItem>
          <FormItem label="地址信息：" prop="consigneeAddressPath">
            {{ addr }}
            <Button class="ml_10" type="default" @click="$refs.map.open()"
              >选择</Button
            >
          </FormItem>
          <FormItem label="详细地址：" prop="consigneeDetail">
            <Input v-model="addressForm.consigneeDetail"></Input>
          </FormItem>
        </Form>
      </div>
      <div slot="footer">
    ...
    <Modal v-model="printModal" width="530" @on-cancel="printCancel">
      ...
      <div class="titBtn">
        <div class="modelTit">
          <Button size="small" @click="printHiddenInfo"
