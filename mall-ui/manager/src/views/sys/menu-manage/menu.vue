        ...
        <div class="treeRight">
          ...
          >
            ...
            <Form-item>
              ...
              <Button @click="handleReset" class="ml_20">重置</Button>
            </Form-item>
          </Form>
        </div>
      </div>
      ...
      >
        ...
        <FormItem label="路由名称：" prop="name" class="block-tool">
          <Tooltip placement="right" content="路由name，需英文唯一，跳转页面用">
            <Input v-model="formAdd.name" class="menu-input" />
          </Tooltip>
        </FormItem>
        <FormItem
          label="文件路径："
        ...
        <FormItem label="权限url：" v-if="formAdd.level != 0">
          <div>
            <Input v-model="formAdd.permission" type="textarea" class="menu-input" />
