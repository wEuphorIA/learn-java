...
<template>
  <div class="contentBox ossBox">
        ...
        <Row class="oss-manage-box">
            ...
            <div class="file-list">
              <div class="article-category mr_10">
                <Tree
                  ...
                  @on-select-change.self="handleCateChange"
          ...
          <Col :span="isComponent ? 19 : 20">
            <div class="pic-list">
              <div>
                <div
                  class="oss-operation padding-row"
                  style="display: flex; flex-direction: row-reverse"
                >
                  <div>
                    <Upload
                      ref="up"
                      :action="commonUrl + '/upload/file'"
                      :data="{
                    ...
                    >
                      ...
                      >
                        <template>
                          <div
                            class="card"
                            @mouseenter.active="onMouseOver(item, index)"
                          ...
                          >
                            ...
                            <div v-if="item.isShowPreview" class="preview">
                              ...
                              <div @click.prevent="handleOpen(item)">
                                <Tooltip content="删除"
    ...
    <Modal v-model="modalVisible" :mask-closable="false" :title="modalTitle">
    ...
    >
      ...
      <div slot="footer">
        ...
        <Button type="primary" @click="submitAddGroup" class="ml_20"
          >确定</Button
        >
      </div>
    </Modal>
...
export default {
  ...
  methods: {
    ...
    async handleContextMenuDelete(val) {
      console.log(this.selectedGroupData.value, 111);
      // this.$Modal.confirm({
      //   title: "提示",
      //   content: "是否删除该分组",
      //   onOk: async () => {
    ...
    treeDataChange(value, selectedData) {
      if (value && value.length) {
        if (value[value.length - 1] == "0") {
          ...
          this.groupFormValidate.level =
            Number(selectedData[selectedData.length - 1].level) + 1;
        }
      }
    },
    // 保存/修改分组
