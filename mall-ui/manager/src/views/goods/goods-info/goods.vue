        ...
        >
          ...
          <template slot="goodsSlot" slot-scope="{ row }">
            <div class="tabInfo">
              ...
              <div class="rText">
                <div class="div-zoom">
                  <span @click="linkTo(row.id, row.skuId)">{{ row.goodsName }}</span>
                </div>
    ...
    >
      <Form ref="underForm" :model="underForm" :label-width="100">
        <FormItem label="下架原因：" prop="reason">
          <Input v-model="underForm.reason" clearable class="wt-400" />
        </FormItem>
      </Form>
      <div slot="footer">
