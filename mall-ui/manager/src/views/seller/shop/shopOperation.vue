<template>
  <div class="base-detail orderDetail">
    <div class="boxBg boxPad">
              ...
              <div class="formBox">
                ...
                <div class="form-item-view">
                  ...
                  <FormItem label="店铺logo：" class="storeLogo">
                    ...
                    />
                    <Button class="ml_20" @click="handleCLickImg('storeLogo')" type="primary"
                      >选择图片</Button
                    >
                  </FormItem>
              ...
              <div class="formBox">
                ...
                <div class="form-item-view">
                  ...
                  <FormItem label="营业执照电子版：">
                    ...
                    <div>
                      <Button
                        @click="handleCLickImg('licencePhoto')"
                        type="primary"
                        >选择图片</Button
                      >
                    </div>
      ...
      <div align="center">
        <Button v-show="tabNameList.indexOf(tabName) > 0" @click="prev"
          >上一步</Button
        >
        <Button
          type="primary"
