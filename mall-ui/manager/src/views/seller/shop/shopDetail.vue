          ...
          <div class="info">
            <div class="head-info">
              ...
              <div class="textR">
                ...
                <p class="phone" v-if="storeInfo.createTime">
                  {{ storeInfo.createTime }}&nbsp;开店
                </p>
                <p class="phone" v-if="storeInfo.selfOperated == 1">
                  <span color="success">自营</span>
                </p>
                <p class="phone" v-else>
                  <span color="error">非自营</span>
                </p>
              </div>
          ...
          <TabPane label="TA的订单" name="order" style="min-height: 200px">
            <Row>
              ...
              >
                ...
                <Button @click="getOrderData" type="primary" class="search-btn"
                  >搜索</Button
                >
              </Form>
            </Row>
        ...
        },
        {
          ...
          render: (h, params) => {
            return h("priceColorScheme", {
              props: { value: params.row.flowPrice },
            });
          },
        },
        {
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.orderStatus == "UNPAID") {
              return h("div", [
                h("span", { class: "statusDot statusRed" }, "未付款"),
              ]);
            } else if (params.row.orderStatus == "PAID") {
              return h("div", [
                h("span", { class: "statusDot statusRreen" }, "已付款"),
              ]);
            } else if (params.row.orderStatus == "UNDELIVERED") {
              return h("div", [
                h("span", { class: "statusDot statusOrange" }, "待发货"),
              ]);
            } else if (params.row.orderStatus == "DELIVERED") {
              return h("div", [
                h("span", { class: "statusDot statusRreen" }, "已发货"),
              ]);
            } else if (params.row.orderStatus == "COMPLETED") {
              return h("div", [
                h("span", { class: "statusDot statusGray" }, "已完成"),
              ]);
            } else if (params.row.orderStatus == "TAKE") {
              return h("div", [
                h("span", { class: "statusDot statusOrange" }, "待核验"),
              ]);
            } else if (params.row.orderStatus == "CANCELLED") {
              return h("div", [
                h("span", { class: "statusDot statusGray" }, "已关闭"),
              ]);
            }
          },
        },
...

        {
          ...
          render: (h, params) => {
            if (params.row.serviceStatus == "APPLY") {
              return h("div", [
                h("span", { class: "statusDot statusOrange" }, "申请中"),
              ]);
            } else if (params.row.serviceStatus == "PASS") {
              return h("div", [
                h("span", { class: "statusDot statusRreen" }, "通过售后"),
              ]);
            } else if (params.row.serviceStatus == "REFUSE") {
              return h("div", [
                h("span", { class: "statusDot statusRed" }, "拒绝售后"),
              ]);
              ...
              return h("div", [
                h("span", { class: "statusDot statusOrange" }, "商家换货/补发"),
              ]);
            } else if (params.row.serviceStatus == "SELLER_CONFIRM") {
              return h("div", [
                h("span", { class: "statusDot statusOrange" }, "卖家确认收货"),
              ]);
            } else if (params.row.serviceStatus == "SELLER_TERMINATION") {
              return h("div", [
                h("span", { class: "statusDot statusRed" }, "卖家终止售后"),
              ]);
            } else if (params.row.serviceStatus == "BUYER_CONFIRM") {
              return h("div", [
                h("span", { class: "statusDot statusGray" }, "买家确认收货"),
              ]);
            } else if (params.row.serviceStatus == "BUYER_CANCEL") {
              return h("div", [
                h("span", { class: "statusDot statusGray" }, "买家取消售后"),
              ]);
            } else if (params.row.serviceStatus == "COMPLETE") {
              return h("div", [
                h("span", { class: "statusDot statusGray" }, "完成售后"),
              ]);
            } else if (params.row.serviceStatus == "WAIT_REFUND") {
              return h("div", [
                h("span", { class: "statusDot statusRed" }, "待平台退款"),
              ]);
            }
          },
        },
