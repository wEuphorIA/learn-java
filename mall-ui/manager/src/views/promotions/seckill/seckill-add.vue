        ...
        <Form ref="form" :model="form" :label-width="120" :rules="formRule">
          <div class="base-info-item">
            <div class="form-item-view">
              ...
              <FormItem label="抢购时间段：" class="info-100" prop="seckillPeriod">
                <Tag
                ...
                ></InputNumber>
                <Button type="default" class="ml_10" @click="addPeriod">添加时间段</Button>
              </FormItem>
...
export default {
  ...
  methods: {
    ...
    removePeriodTime(event, name) {
      // 移除秒杀时间段
      this.form.seckillPeriod = this.form.seckillPeriod.filter(
        (i) => i !== name
      );
    },
    // // 申请截止时间格式化
