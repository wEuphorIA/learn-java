  ...
  <div class="contentBox">
    <div class="seckill">
      ...
      <div class="boxBg boxPad m24">
        <div class="export">
          <Button type="primary" @click="handleCreate">创建一周秒杀活劫</Button>
        </div>
        <div class="tableBox">
            ...
            <TabPane label="秒杀活动列表" name="list">
              ...
              >
                <template slot-scope="{ row }" slot="action">
                  ...
                  <span class="fontCol ml_20" v-else @click="manage(row)"
                    >查看</span
                  >
