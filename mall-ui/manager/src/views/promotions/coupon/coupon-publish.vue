          ...
          <div class="formBox">
            ...
            <div class="form-item-view">
              ...
              <FormItem label="优惠券类型：" prop="couponType">
                <Select :disabled="disabled" v-model="form.couponType">
              ...
              >
                <Input
                  ...
                  clearable
                />
                <div class="describe">请输入0-10之间数字，可以输入一位小数</div>
              </FormItem>
              <FormItem
                label="面额："
                prop="price"
              ...
              <FormItem label="活动类型：" prop="getType">
                <Select :disabled="disabled" v-model="form.getType">
              ...
              <FormItem label="店铺承担比例：" prop="storeCommission">
                ...
                <div class="describe">店铺承担比例，输入0-100之间数值</div>
              </FormItem>
              <FormItem
                label="发放数量："
                prop="publishNum"
            ...
            <div class="form-item-view">
              ...
              <FormItem label="使用范围：" prop="scopeType">
                ...
                >
                  ...
                  <Radio :disabled="disabled" label="PORTION_GOODS"
                    >指定商品</Radio
                  >
