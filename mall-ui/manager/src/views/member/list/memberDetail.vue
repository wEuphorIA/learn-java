        ...
        <div class="dialogCenter">
          ...
          >
            ...
            <FormItem label="收货人地址：" prop="consigneeAddressPath">
              ...
              <Button @click="$refs.map.open()" style="margin-left: 10px"
                >选择</Button
              >
            </FormItem>
          ...
          render: (h, params) => {
            if (params.row.pointType == "INCREASE") {
              return h("priceColorScheme", {
                props: {
                  value: params.row.variablePoint,
                  color: "green",
                  unit: "+",
                },
              });
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.money > 0) {
              return h("priceColorScheme", {
                props: { value: params.row.money, color: "green" },
              });
            } else if (params.row.money < 0) {
              return h("priceColorScheme", {
                props: { value: params.row.money, color: this.$mainColor },
              });
            }
          },
        },
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.receiptPrice == null) {
              return h("priceColorScheme", {
                props: { value: 0, color: this.$mainColor },
              });
            } else {
              return h("priceColorScheme", {
                props: {
